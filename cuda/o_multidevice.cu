...
void* routine( void *pvoidData ) {
    ...
    data->elapsedTime += elapsedTimeLocal; // Suma el tiempo usado en cada GPU para obtener el total de tiempo de ejecución
...
int main( void ) {
    ...
    printf("Total GPU time used: %f ms \n", data[0].elapsedTime + data[1].elapsedTime);
